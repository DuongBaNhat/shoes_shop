...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleNotFoundException(NotFoundException ex) {
        ...
        ExceptionResponse exp = new ExceptionResponse(HttpStatus.BAD_REQUEST.value(), ex.getClass().getName(),
    ...
    public ResponseEntity<Object> handleAllExceptions(Exception ex) {
        ...
        ExceptionResponse expRes = new ExceptionResponse(HttpStatus.BAD_REQUEST.value(), ex.getClass().getName(),
                ex.getMessage(), ex.getStackTrace()[0]);
